...
MIM_plot3 <- ggplot(data, aes(x=residual, y=pred_MAP, color=SLOPE)) + geom_point() +
  #scale_color_gradient2(midpoint=midp, low="blue", mid="green", high="red", space ="Lab" ) +
  #xlim(0,10) +
  #ylim(0,10) +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed") +
...
MIM_plot4 <- ggplot(data, aes(x=residual, y=CLAY, color=MAT)) + geom_point() +
  #scale_color_gradient2(low="brown", mid="yellow", high="green", 
...
#MIMtable <- as.data.frame(table)
#colnames(MIMtable)[1] <- "Site"
#data$Site <- as.character(data$Site)
#export_df <- full_join(data, MIMtable)
#write.csv(export_df, "MIMtable_eGPP_121020.csv")
