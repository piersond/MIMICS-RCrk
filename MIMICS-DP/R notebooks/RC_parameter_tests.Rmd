---
title: "RCrk MIMICS: Parameter tests"
output:
  html_document:
    code_folding: hide
---
...
Stating with a test of sensivity. Model has been using the mean LiDET litter fMET (0.384). Plots below observe effect on residuals using the minimum (0.148) and maximum (0.76)values in the LiDET dataset.
